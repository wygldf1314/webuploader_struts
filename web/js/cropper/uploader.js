    ...
    return {
        init: function( selectCb ) {
            uploader = new Uploader({
                ...
                server: 'http://cms.netstudy5.dev/common/webuploader.htm',
                swf: 'http://cms.netstudy5.dev/js-webuploader/dist/Uploader.swf',
                fileNumLimit: 2,
                onError: function() {
...
var Croper = (function() {
    ...
    function srcWrap( src, cb ) {
        ...
        if ( isBase64Supported ) {
            ...
            $.ajax('http://cms.netstudy5.dev/common/webuploader64.htm', {
                method: 'POST',
                data: src
